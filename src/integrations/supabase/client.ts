...
// הגדרת משתני הזמן ששאר חלקי האפליקציה מחפשים כדי למנוע קריסה
const now = new Date();
...
export const mockData = {
  workout_plans: [
    { id: "p1", name: "Full Body Elite", description: "Hypertrophy focused routine", created_at: now.toISOString() }
  ],
  workout_sessions: [
